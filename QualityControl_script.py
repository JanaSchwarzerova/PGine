...
def quality_control():
    ...
    for index, row in df.iterrows():
        ...
        # Allowing a 10% deviation from the expected 50%
        if abs(heterozygous_frequency - expected_heterozygosity) > 0.1:
    ...
    for column in df.columns[1:]:  # All columns except 'Marker'
        ...
        # Example: We expect frequencies in the range of 0.1 to 0.9
